...
public class UserController {
    ...
    public void initialize() {
        ...
        // Try to load from database first, if fails, load dummy data
        try {
            getUsers();
            countusers();
        } catch (Exception e) {
            System.out.println("Database connection failed, loading dummy data...");
            loadDummyData();
        }
        
        // If table is still empty, force dummy data
    ...
    private void loadDummyData() {
        ...
        ObservableList<User> dummyData = FXCollections.observableArrayList();
        
        dummyData.add(new User("John Doe", 35, "Monday", "Colombo", "077-1234567"));
        dummyData.add(new User("Jane Smith", 28, "Tuesday", "Galle", "071-9876543"));
        dummyData.add(new User("Mike Wilson", 42, "Wednesday", "Kandy", "076-5555555"));
        dummyData.add(new User("Sarah Johnson", 31, "Thursday", "Negombo", "078-1111111"));
        dummyData.add(new User("David Brown", 39, "Friday", "Matara", "075-2222222"));
        dummyData.add(new User("Lisa Davis", 26, "Saturday", "Trincomalee", "072-3333333"));
        dummyData.add(new User("Tom Anderson", 45, "Sunday", "Jaffna", "077-4444444"));
        
        userTable.setItems(dummyData);
        if (totalUsersLabel != null) {
            totalUsersLabel.setText(String.valueOf(dummyData.size()));
        }
        
        System.out.println("Successfully loaded " + dummyData.size() + " dummy users into table");
