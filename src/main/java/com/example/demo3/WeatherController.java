...
public class WeatherController {
    ...
    @FXML private Label seaTempLabel;
    
    // Safety status card elements
    @FXML private Label safetyIconLabel;
    @FXML private Label safetyStatusLabel;
    @FXML private Label waveConditionStatus;
    @FXML private Label windSpeedStatus;
    @FXML private Label visibilityStatus;
    
    // Bottom metrics elements
    @FXML private Label tideStatusLabel;
    @FXML private Label uvIndexLabel;
    @FXML private Label currentHumidityLabel;
    ...
    public void selectFishingArea(javafx.event.ActionEvent event) {
        ...
        switch (areaName) {
            case "Negombo":
                ...
                if (searchLocationField != null) searchLocationField.setText("Negombo, Sri Lanka");
                break;
            case "Chilaw":
                latitudeField.setText("7.58");
                longitudeField.setText("79.80");
                if (searchLocationField != null) searchLocationField.setText("Chilaw, Sri Lanka");
                break;
            case "Trincomalee":
                latitudeField.setText("8.59");
                longitudeField.setText("81.21");
                if (searchLocationField != null) searchLocationField.setText("Trincomalee, Sri Lanka");
                break;
            case "Galle":
                latitudeField.setText("6.03");
                longitudeField.setText("80.22");
                if (searchLocationField != null) searchLocationField.setText("Galle, Sri Lanka");
                break;
            case "Mirissa":
                latitudeField.setText("5.95");
                longitudeField.setText("80.46");
                if (searchLocationField != null) searchLocationField.setText("Mirissa, Sri Lanka");
                break;
            case "Kalpitiya":
                latitudeField.setText("8.23");
                longitudeField.setText("79.77");
                if (searchLocationField != null) searchLocationField.setText("Kalpitiya, Sri Lanka");
                break;
        }
    ...
    private void updateWeatherOverviewCards() {
        ...
        if (safetyStatusLabel != null) {
            safetyStatusLabel.setText(isSafe ? "Safe for Fishing" : (alertLevel == 2 ? "Dangerous Conditions" : "Use Caution"));
        }
        if (waveConditionStatus != null) {
            waveConditionStatus.setText(currentWaveHeight < 1.5 ? "Good" : currentWaveHeight < 2.5 ? "Moderate" : "Poor");
        }
